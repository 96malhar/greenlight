[![Build status](https://img.shields.io/github/actions/workflow/status/96malhar/greenlight/CI.yml?label=CI&branch=main)](https://github.com/96malhar/greenlight/actions/workflows/CI.yml)
